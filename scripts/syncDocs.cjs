...
const paths = {
  ...
  readmeMatching: path.join(__dirname, '../README_CV_Matching_Parsing.md'),
  readmeInterview: path.join(__dirname, '../README_Interview_System.md'),
};
...
`;
  ...
  console.log('[AutoDoc] CV Matching & Parsing README generated successfully.');
}
...
`;
  ...
  console.log('[AutoDoc] Interview System README generated successfully.');
}
...
function runSync() {
  try {
    ...
    console.log('[AutoDoc] All READMEs successfully updated!');
  } catch (err) {
